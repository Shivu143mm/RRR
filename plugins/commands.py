...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    InlineKeyboardButton('🙄 𝗔𝗗𝗗 𝗠𝗘 𝗧𝗢  🥰', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
                ],[
                    InlineKeyboardButton('💸 🫣 𝗘𝗔𝗥𝗡 𝗠𝗢𝗡𝗘𝗬 🤑', callback_data="owner_info"),
                  
                ],[
                    InlineKeyboardButton('🤧 𝗛𝗘𝗟𝗣 🤧', callback_data='help'),
                    
                    InlineKeyboardButton('⚜ 𝗝𝗢𝗜𝗡 𝗨𝗣𝗗𝗘𝗧𝗘 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 ⚜', url=CHNL_LNK)
                  ]]
        ...
        reply_markup=InlineKeyboardMarkup(
            [
             [
              ...
              InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url="t.me/DwayneJohnson")
             ]
            ]
        )
    )
...
async def delete(bot, message):
    ...
    if result.deleted_count:
        ...
        if result.deleted_count:
            ...
            # files indexed before https://github.com/EvamariaTG/EvaMaria/commit/f3d2a1bcb155faf44178e5d7a685a1b533e714bf#diff-86b613edf1748372103e94cacf
